                            ...
                            @foreach ($community_data as $item)
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="card mb-2 bg-gradient-dark">
                                        <img class="card-img-top" src="{{asset('backend/images/community/'.$item->image)}}"
                                            alt="Dist Photo 1">
                                        <div class="card-img-overlay d-flex flex-column justify-content-end">
                                            ...
                                            <form action="{{route('community.destroy',$item->id)}}" method="post" id="form1">
                                                @csrf
                                            <a href="{{route('community.edit',$item->id)}}" class="text-white"><i class="fas fa-edit"
