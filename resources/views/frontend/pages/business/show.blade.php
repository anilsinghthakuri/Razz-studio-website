        ...
        <div class="container-fluid">
            <div class="inner__header--pageName">
                ...
                <p><a href="{{route('frontend.home')}}">Home</a><i class="fas fa-chevron-right"></i><i class="fas fa-chevron-right"></i>
                    <a href="{{route('frontend.business')}}"> <span>Business</span> </a><i class="fas fa-chevron-right"></i><span>{{$business->title}}</span></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="core__feature">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="about-img " alt="Razz" src="{{asset('backend/images/business/'.$business->image)}}">
                    </div>
                    <div class="col-md-6">
                        <div class="about-contain pt-5">

                            <p class="content-desc">{{$business->desc}}</p>
                        </div>
                    </div>
                </div>
            </div>
