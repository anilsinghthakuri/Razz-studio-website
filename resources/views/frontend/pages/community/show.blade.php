        ...
        <div class="container-fluid">
            <div class="inner__header--pageName">
                ...
                <p><a href="{{route('frontend.home')}}">Home</a><i class="fas fa-chevron-right"></i><i
                    ...
                    <a href="{{route('frontend.community')}}"> <span>Community</span> </a><i
                        class="fas fa-chevron-right"></i><span>{{$community->community_name}}</span></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="core__feature">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="about-img " alt="Razz" src="{{asset('backend/images/community/'.$community->image)}}">
                    </div>
                    <div class="col-md-6">
                        <div class="about-contain pt-5">
                            <p class="content-desc">{{$community->desc}}</p>
                        </div>
                    </div>
                </div>
            </div>
